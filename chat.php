...
if (isset ( $_POST ['enter'] )) {
    if ($_POST ['name'] != "") {
        ...
        $fp = fopen ( "log.html", 'a' );
        fwrite ( $fp, "<div class='msgln'><i>User " . $_SESSION ['name'] . " has started chat session.</i><br></div>" );
        fclose ( $fp );
    } else {
...
if (isset ( $_GET ['logout'] )) {
    ...
    // Simple exit message
    $fp = fopen ( "log.html", 'a' );
    fwrite ( $fp, "<div class='msgln'><i>User " . $_SESSION ['name'] . " has stoped the chat session.</i><br></div>" );
    fclose ( $fp );
